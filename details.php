...
session_start();
$prod = $_GET['id'];
$req = "SELECT * FROM produit WHERE id='$prod'";
?>
        ...
        <div id="main_container">
            ...
            <div id="main_content"> 
                ...
                <div class="center_content">
                    ...
                    while ($row = $res->fetch()) {
                        ?>
                        <div class="center_title_bar"><?php echo $row['nom']; ?></div>
                        ...
                        <div class="prod_box_big">
                            ...
                            <div class="center_prod_box_big">            
                                ...
                                <div class="product_img_big">
                                    <img src="images/<?php echo $row['img']; ?>" alt="" title="" border="0" />
                                    
                                </div>
                                <div class="details_big_box">
                                    <div class="product_title_big"><?php echo $row['nom']; ?></div>
                                    ...
                                    <div class="prod_price_big"><span class="price"><?php echo $row['prix']; ?>$</span></div>
