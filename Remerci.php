                        ...
                        <div class="oferta_details">
                            <div class="oferta_text">
                                <font color="#000099" size="3px"> 
                                    ...
                                    ?>
                                    Felicitation !!! grace a votre achat vous avez obtenue des points de fidelites <br/><br/>
                                    Le prix total a payer est :<?php echo $prx; ?> $<br/><br/>
                                    ...
                                    while ($row = $res->fetch())
                                        $pnt = $pnt + $row['point'];
                                    ?>
                                    Vos points de fidelite est :<?php echo $pnt; ?> points (10 $ pour chaque point)<br/>
                                    <br/>
                                    <?php
                                    $sql = "update users set point=" . $pnt . " where id=" . $user;
                                    //echo "".$sql;
                                    $db->query($sql);
                                    ?>
                                    <a href="logout.php" class="quitter">Quitter</a>
                                </font>
